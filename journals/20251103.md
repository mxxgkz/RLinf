...
## Copy file
- Can copy from quest to magics: `scp -rv kzy816@quest:/projects/p30309/RL/RLinf/logs/20251103-06\:10\:02 /home/guo/RL/RLinf/ckpts/`
...
- ✅ Model weights (actor network)
- ✅ Optimizer state (Adam parameters)  
- ✅ Global step counter (training continues from checkpoint step)
- ✅ Training resumes seamlessly — next checkpoint saves at step 80, 120, etc.
...
- All other config settings remain the same — only add `resume_dir`
