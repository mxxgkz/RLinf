...
do
STD_OUTPUT_FILE="/home/guo/RL/${FOLDER_NAME}/script/clusters/std_output/${IDX}.log"
...
source "/home/guo/RL/${FOLDER_NAME}/script/clusters/magics/setup_embodiment_env.sh"
...
done < /home/guo/RL/${FOLDER_NAME}/script/clusters/magics/param.info
